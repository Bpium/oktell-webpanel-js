...
(function($) {
  ...
  templates = {
    ...
    'templates/actionList.html': '<ul class="b_actions_group_list"><li class="{{css}}" data-action="{{action}}"><i></i><span>{{actionText}}</span></li></ul>',
