...
(function($) {
  ...
  checkCssAnimationSupport = (function(_this) {
    return function() {
  ...
  initPanel = function(opts) {
    ...
    if (getOptions().useNotifies && window.webkitNotifications && window.webkitNotifications.checkPermission() === 1) {
      webkitNotifications.requestPermission((function(_this) {
        return function() {};
      })(this));
    }
    ...
    if (!useContainer) {
      ...
      hidePanel = function() {
        if (useCssAnim) {
          if (!cssAnimNow) {
            ...
            return hideTimer = setTimeout((function(_this) {
              return function() {
      ...
      panelEl.bind("mouseenter", (function(_this) {
        return function() {
          mouseOnPanel = true;
          killPanelHideTimer();
      ...
      touchMoving = false;
      enableMoving = false;
      panelBookmarkEl.bind('touchstart', (function(_this) {
        return function() {
      ...
      panelBookmarkEl.bind('touchmove', (function(_this) {
        return function(e) {
      ...
      panelBookmarkEl.bind('touchend', (function(_this) {
        return function() {
          var pos;
          if (!touchMoving) {
      ...
      panelBookmarkEl.bind('touchcancel', (function(_this) {
        return function() {
          return true;
        };
      })(this));
      $(window).bind('touchcancel', (function(_this) {
        return function(e) {
          return true;
        };
      })(this));
      $(window).bind('touchend', (function(_this) {
        return function(e) {
  ...
  $.oktellPanel.show = (function(_this) {
    return function() {
      return list.showPanel();
    };
  })(this);
  return $.oktellPanel.hide = (function(_this) {
    return function() {
