...
(function($, ko) {
  var actionButtonHtml, actionList, actionListEl, actionListHtml, addActionButtonToEl, afterOktellConnect, defaultOptions, elsForInitButtonAfterConnect, elsWithButton, getOptions, initActionButtons, initBttonOnElement, initPanel, langs, list, loadTemplate, oktell, oktellConnected, options, panel, panelEl, panelHtml, panelWasInitialized, popupHtml, userTemplateHtml, usersService;
  ...
  initPanel = function(opts) {
    ...
    return $('.b_phone_keypad li a', panelEl).bind('click', function(e) {
      var input;
