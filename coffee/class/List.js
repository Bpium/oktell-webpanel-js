...
List = (function() {
  ...
  function List(oktell, panelEl, dropdownEl, afterOktellConnect, options, contained, useSticky, useNativeScroll, debugMode) {
    this.onPbxNumberStateChange = bind(this.onPbxNumberStateChange, this);
    ...
    this.buttonShowOffline.bind('click', (function(_this) {
      return function() {
        _this.config({
    ...
    this.buttonShowDeps.bind('click', (function(_this) {
      return function() {
        _this.config({
    ...
    this.dtmfEl.find('.o_close').bind('click', (function(_this) {
      return function() {
        return _this.hideDtmf();
      };
    })(this));
    this.dtmfEl.find('.btn-small').bind('click', (function(_this) {
      return function(e) {
    ...
    this.config();
    Department.prototype.config = (function(_this) {
      return function() {
        var args;
    ...
    this.initJScrollPane = (function(_this) {
      return function() {
    ...
    this.reinitScroll = (function(_this) {
      return function() {
        var ref;
        if (!_this.useNativeScroll) {
          return (ref = _this.jScrollPaneAPI) != null ? ref.reinitialise() : void 0;
        }
      };
    })(this);
    this.resetDepsWidth = (function(_this) {
      return function() {
        var ref, w;
        if (!_this.useNativeScroll && !_this.contained && _this.scrollContent) {
          ...
          return (ref = _this.currentTopHeaderClone) != null ? ref.css({
            width: w + 'px'
          }) : void 0;
        }
      };
    })(this);
    this.userScrollerToTop = (function(_this) {
      return function() {
        if (!_this.useNativeScroll) {
    ...
    this.filterClearCross.bind('click', (function(_this) {
      return function() {
        return _this.clearFilter();
      };
    })(this));
    this.filterInput.bind('keyup', (function(_this) {
      return function(e) {
    ...
    this.panelEl.bind('click', (function(_this) {
      return function(e) {
    ...
    this.dropdownEl.bind('click', (function(_this) {
      return function(e) {
    ...
    dropdownHideTimer = '';
    this.dropdownEl.hover((function(_this) {
      return function() {
    ...
    this.panelEl.find('.j_keypad_expand').bind('click', (function(_this) {
      return function() {
        _this.toggleKeypadVisibility();
        return _this.filterInput.focus();
      };
    })(this));
    this.keypadEl.find('li').bind('click', (function(_this) {
      return function(e) {
    ...
    this.setUserListHeight = (function(_this) {
      return function() {
        var h;
    ...
    debouncedSetHeight = debounce((function(_this) {
      return function() {
    ...
    oktell.on('webphoneConnect', (function(_this) {
      return function() {
        return _this.panelEl.addClass('webphone');
      };
    })(this));
    oktell.on('webphoneDisconnect', (function(_this) {
      return function() {
    ...
    oktell.on('disconnect', (function(_this) {
      return function() {
        ...
        _this.setQueue([]);
        ref = _this.userWithGeneratedButtons;
        results = [];
        for (phone in ref) {
          user = ref[phone];
          results.push(user.loadActions());
        }
        return results;
      };
    })(this));
    onConnect = (function(_this) {
      return function() {
        var createdDeps, dep, id, j, len, numObj, number, oId, oInfo, oNumbers, oUser, oUsers, otherDep, ref, ref1, ref2, strNumber, user;
        _this.oktellConnected = true;
        oInfo = oktell.getMyInfo();
        oInfo.userid = oInfo.userid.toString().toLowerCase();
        _this.myNumber = (ref = oInfo.number) != null ? ref.toString() : void 0;
        ...
        for (id in oUsers) {
          if (!hasProp.call(oUsers, id)) continue;
          user = oUsers[id];
          delete oNumbers[user.number];
        }
        for (number in oNumbers) {
          if (!hasProp.call(oNumbers, number)) continue;
        ...
        for (oId in oUsers) {
          if (!hasProp.call(oUsers, oId)) continue;
          oUser = oUsers[oId];
          strNumber = ((ref1 = oUser.number) != null ? ref1.toString() : void 0) || '';
          if (!strNumber) {
            continue;
          }
        ...
        ref2 = _this.usersWithBeforeConnectButtons;
    ...
    oktell.on('abonentsChange', (function(_this) {
    ...
    oktell.on('holdStateChange', (function(_this) {
      return function(holdInfo) {
        if (_this.oktellConnected) {
    ...
    oktell.on('talkTimer', (function(_this) {
      return function(seconds, formattedTime) {
        if (_this.oktellConnected) {
          if (seconds === false) {
    ...
    oktell.on('queueChange', (function(_this) {
    ...
    ringNotify = null;
    oktell.on('ringStart', (function(_this) {
      return function(abonents) {
  ...
  List.prototype.initStickyHeaders = function() {
    var conTop, h, i, j, l, len, len1, ref, ref1;
  ...
  List.prototype.processStickyHeaders = function(elIndex) {
    var conTop, curTop, nexTop, ref, ref1;
    if (((ref = this.headerEls) != null ? ref.length : void 0) > 0) {
      if (elIndex != null) {
        if (elIndex < 0) {
          elIndex = 0;
        }
        this.currentTopIndex = elIndex;
        if ((ref1 = this.currentTopHeaderClone) != null) {
          ref1.remove();
        }
        ...
        this.currentTopHeaderClone.bind('click', (function(_this) {
          return function() {
  ...
  List.prototype.resetStickyHeaders = function() {
    var ref;
    if ((ref = this.currentTopHeaderClone) != null) {
  ...
  List.prototype.showDtmf = function(dontAnimate) {
    if (this.oktell.getState() === 'talk' && this.panelEl.hasClass('webphone') && !this.panelEl.hasClass('dtmf')) {
      ...
      if (dontAnimate) {
        ...
        this.resetStickyHeaders();
        return this.dtmfEl.slideDown(200, (function(_this) {
          return function() {
            return _this.initStickyHeaders();
          };
        })(this));
  ...
  List.prototype.hideDtmf = function(dontAnimate) {
    if (this.panelEl.hasClass('dtmf')) {
      ...
      if (dontAnimate) {
        ...
        this.resetStickyHeaders();
        return this.dtmfEl.slideUp(200, (function(_this) {
          return function() {
            return _this.initStickyHeaders();
          };
        })(this));
  ...
  List.prototype.onPbxNumberStateChange = function(data) {
    var dep, index, j, len, n, numStr, ref, ref1, ref2, ref3, ref4, ref5, results, user, userNowIsFiltered, wasFiltered;
    ref = data.numbers;
    results = [];
      ...
      if (user) {
        ...
        if (!userNowIsFiltered) {
          if (dep.getContainer().children().length === 1) {
            results.push(this.setFilter(this.filter, true, true));
          } else {
            results.push((ref1 = user.el) != null ? typeof ref1.detach === "function" ? ref1.detach() : void 0 : void 0);
          }
        } else if (!wasFiltered) {
          ...
          if (index !== -1) {
            if (!dep.getContainer().is(':visible')) {
              ...
              if (index === 0) {
                ...
                if ((ref2 = dep.lastFilteredUsers[index - 1]) != null) {
                  if ((ref3 = ref2.el) != null) {
                    ref3.after(user.getEl());
                  }
                }
              }
              if (((ref4 = dep.lastFilteredUsers[index - 1]) != null ? ref4.letter : void 0) === user.letter) {
                results.push(user.letterVisibility(false));
              } else if (((ref5 = dep.lastFilteredUsers[index + 1]) != null ? ref5.letter : void 0) === user.letter) {
                results.push(dep.lastFilteredUsers[index + 1].letterVisibility(false));
              } else {
                results.push(void 0);
              }
            }
  ...
  List.prototype.hideActionListDropdown = function() {
    return this.dropdownEl.fadeOut(150, (function(_this) {
      return function() {
  ...
  List.prototype.getUserButtonForPlugin = function(phone) {
    ...
    button.find('.drop_down').bind('click', (function(_this) {
      return function() {
        var actions;
  ...
  List.prototype.showDropdown = function(user, buttonEl, actions, onPanel, useDtmfAsAction) {
    ...
    if (actions != null ? actions.length : void 0) {
      ...
      for (j = 0, len = actions.length; j < len; j++) {
        a = actions[j];
        if (typeof a === 'string' && ((ref = this.allActions[a]) != null ? ref.text : void 0)) {
  ...
  List.prototype.logUsers = function() {
    var k, ref, results, u;
    ref = this.panelUsersFiltered;
    results = [];
    for (k in ref) {
      if (!hasProp.call(ref, k)) continue;
      u = ref[k];
      results.push(this.log(u.getInfo()));
    }
    return results;
  };

  List.prototype.syncAbonentsAndUserlist = function(abonents, userlist) {
    var absByNumber, ref, results, uNumber, user;
    absByNumber = {};
    if ((abonents != null ? abonents.length : void 0) === 0 || (abonents.length === 1 && ((ref = abonents[0]) != null ? ref.isIvr : void 0))) {
      for (uNumber in userlist) {
        if (!hasProp.call(userlist, uNumber)) continue;
        user = userlist[uNumber];
        delete userlist[uNumber];
      }
    }
    $.each(abonents, (function(_this) {
      return function(i, ab) {
        var number, ref1, u;
        if (!ab) {
          return;
        }
        number = ((ref1 = ab.phone) != null ? typeof ref1.toString === "function" ? ref1.toString() : void 0 : void 0) || ab.ivrName || '';
        if (!number) {
          return;
        }
    ...
    for (uNumber in userlist) {
      ...
      if (!absByNumber[user.number]) {
        results.push(delete userlist[user.number]);
      } else {
        results.push(void 0);
      }
    }
  ...
  List.prototype.setAbonents = function(abonents) {
    var abonent, number, ref, ref1;
    this.log('setAbonents', abonents, this.abonents);
    ref = this.abonents;
    for (number in ref) {
      if (!hasProp.call(ref, number)) continue;
      abonent = ref[number];
    ...
    if (!this.oktell.conferenceId) {
      ref1 = this.abonents;
      for (number in ref1) {
        if (!hasProp.call(ref1, number)) continue;
        abonent = ref1[number];
        abonent.addAction('dtmf', (function(_this) {
          return function() {
  ...
  List.prototype.setQueue = function(queue) {
    var ab, j, key, len, ref, user;
    if (this.oktell.getState() === 'ring') {
      for (key = j = 0, len = queue.length; j < len; key = ++j) {
        ab = queue[key];
  ...
  List.prototype._setActivityPanelUserHtml = function(users, listEl, blockEl) {
    ...
    usersArray = [];
    for (k in users) {
      if (!hasProp.call(users, k)) continue;
      u = users[k];
      usersArray.push(u);
    }
    ...
    if (usersArray.length && blockEl.css('display') === 'none') {
      ...
      this.resetStickyHeaders();
      return blockEl.slideDown(50, (function(_this) {
        return function() {
          _this.setUserListHeight();
          return _this.initStickyHeaders();
        };
      ...
      blockEl.stop(true, true);
      this.resetStickyHeaders();
      return blockEl.slideUp(50, (function(_this) {
        return function() {
          _this.setUserListHeight();
          return _this.initStickyHeaders();
        };
  ...
  List.prototype._setUsersHtml = function(usersArray, $el, useIndependentCopies) {
    var html, j, lastDepId, len, prevLetter, u, userEl;
    html = [];
    lastDepId = null;
    prevLetter = '';
    for (j = 0, len = usersArray.length; j < len; j++) {
      u = usersArray[j];
  ...
  List.prototype.setFilter = function(filter, reloadAnyway, notScrollTop) {
    var allDeps, dep, el, exactMatch, j, len, oldFilter, ref, renderDep;
    ...
    this.panelUsersFiltered = [];
    allDeps = [];
    renderDep = (function(_this) {
      return function(dep) {
        var depExactMatch, el, ref, users;
        el = dep.getEl(filter !== '');
        ...
        depExactMatch = false;
        ref = dep.getUsers(filter, _this.showOffline, _this.filterLang), users = ref[0], depExactMatch = ref[1];
  ...
  List.prototype.getUser = function(data, dontRemember) {
    var fantom, numberFormatted, ref, strNumber;
    ...
    if (!data.isIvr && !dontRemember && ((ref = this.filterFantomUser) != null ? ref.number : void 0) === strNumber) {
  ...
  List.prototype.reloadActions = function() {
    return setTimeout((function(_this) {
      return function() {
        var actions, phone, ref, ref1, ref2, ref3, results, user;
        ref = _this.userWithGeneratedButtons;
        for (phone in ref) {
          if (!hasProp.call(ref, phone)) continue;
          user = ref[phone];
          actions = user.loadActions();
        }
        ref1 = _this.abonents;
